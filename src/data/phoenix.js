  ...
  stories: [
    {
      ...
      excerpt: ["He wasn't the kind of person who filled rooms with laughter or energy. He didn't turn heads or dominate conversations. But he watched. He listened. He thought. And within that quiet exterior was a world no one really saw. Not because he hid it-but because no one ever asked to look.",
               ...
               "Each night, lying in that small room, he rehearsed sentences he'd never say out loud. And each morning, he stepped out wearing the mask of someone who didn't have anything to say.", "~Continue the story: Parts 2 & 3 await in the magazine~"]
    },
  ],
  poems: [
    {
    ...
    },
    {
      ...
      author: "Subhodeep Chakraborty",
      content: [
        "শুনলাম তারা তোমায় নাকি সন্মান দেবে?",

        "সে দিক তাতে ভালোই হবে, তাদের এতদিন পর মনে পড়েছে দেশবাসীর প্রাণে সুভাষ রয়েছে।",

        "তোমায় নিয়ে চলছে এখন ভীষণ রাজনীতি, ভাবিনি এদেশ করবে তোমার এমন পরিণতি।",

        "এ বলে নেতাজি আমার দলের তো ও বলে আমার, রাজনীতিতে ভুলেই গেছে নেতাজি তো সবার।",

        "স্বাধীনতা তুমি এনেছো দেশে দেশ মা আজ তোমায় ডাকছে ভালোবেসে, ফিরবে তুমি এদেশেতেই মনেতে আশা রাখি তুমি তো নেতাজী, জানি তুমি দেবে না মোদের ফাঁকি।",

        "বাড়িতে বাড়িতে সবাই নেতা কেও রাম তো কেও ফুলে পোতা মুখেই তাদের বড়ো বড়ো কথা কাজের বেলায় তারাই লাপাতা।",
        ...
        "স্বাধীন হয়েও পরাধীন এদেশ ভুলেছে স্বাধীনতার স্বাদ জানি তুমি আসবে আবার আহা এ গন্ধ যে স্বাধীনতার",
  ...
  images: [
    {
      ...
      caption: "The calm before the storm. Exam season, 2024."
    },
    {
      id: 2,
      src: "https://images.unsplash.com/photo-1541339907198-e08756dedf3f?w=800&q=80",
      caption: "The last sunset from the hostel roof."
    }
  ]
};
