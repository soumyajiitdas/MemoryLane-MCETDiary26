...
const Scrapbook = () => {
  useEffect(() => { document.title = "MCET Diary '26 | Scattered Memories"; }, []);
  ...
  return (
    <PageTransition>
      <div className="relative overflow-hidden w-full min-h-screen">
        ...
        {/* Firefly Particles */}
        <div className="absolute inset-0 pointer-events-none"><Fireflies count={30} /></div>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span className="relative z-10">Scrapbook</span>
                </button>
                <button
