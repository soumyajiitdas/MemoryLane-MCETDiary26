  ...
  return (
    <div className={`relative flex flex-col md:flex-row items-center w-full mb-32 last:mb-0 ${isEven ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
      ...
      >
        ...
        >
           ...
           >
              ...
              <div className="absolute top-4 right-4 w-[80px] h-[80px] border-[3px] border-red-800/40 rounded-full flex items-center justify-center rotate-[-15deg] z-20 mix-blend-multiply opacity-70 shadow-sm pointer-events-none">
                <div className="border-[1.5px] border-dashed border-red-800/40 rounded-full w-[68px] h-[68px] flex items-center justify-center text-center leading-none">
              ...
              <div className="absolute bottom-4 right-4 text-amber-900/30 italic font-serif text-[10px] uppercase tracking-[0.3em]">
                Diary '26
              </div>
           </div>
        </motion.div>
        ...
        {/* Mobile-only hint */}
        <div className="md:hidden font-sans uppercase mt-6 text-white/40 tracking-widest text-xs flex items-center gap-4 font-semibold">
      ...
      <div className="relative overflow-hidden w-full min-h-screen">
        ...
        <div className="py-24 pb-30 relative z-20">
          <div className="max-w-[1400px] mx-auto px-4 relative z-10">
            ...
            <p className="text-center font-serif italic font-light text-2xl md:text-3xl text-white/60 -mt-10 mb-24 max-w-2xl mx-auto">
