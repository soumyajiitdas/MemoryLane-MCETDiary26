          ...
          <div className="flex flex-col">
            ...
            {page.excerpt.map((line, i) => {
              ...
              return (
                <p
                  key={i}
                  className={`font-serif text-md leading-relaxed text-[#4a3f32] mb-4 last:mb-0 ${isFirst
    ...
    <>
      <PageTransition>
        <div className="relative overflow-hidden w-full min-h-screen">
          ...
          {/* Firefly Particles */}
        <div className="absolute inset-0 pointer-events-none"><Fireflies count={20} /></div>
