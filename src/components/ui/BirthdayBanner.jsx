    ...
    <AnimatePresence>
      {isVisible && (
        <>
          ...
          >
            {/* Main sticky banner */}
            <div className="px-4 py-3 bg-[url('https://www.transparenttextures.com/patterns/aged-paper.png')] bg-[#100f0d] shadow-xl border-b-2 border-amber-900/20 overflow-hidden relative">
